# DWNO UnlockAllRequirements Mod

This mod shows all evolution hints in the history as unlocked.
...
3. Copy the `UnlockAllRequirements.dll` into the `plugins` folder of BepinEx
...
The `UnlockAllRequirements.dll` should now be in `bin/Release/net6.0`.
